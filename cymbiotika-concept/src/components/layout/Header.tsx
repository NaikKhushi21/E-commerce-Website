                ...
                return (
                  <li key={link.href}>
                    <Link
                      ...
                      aria-current={active ? "page" : undefined}
                      className={cn(
                        "flex items-center justify-between rounded-2xl px-4 py-4 text-base uppercase tracking-[0.14em] transition-colors duration-300",
                        active
