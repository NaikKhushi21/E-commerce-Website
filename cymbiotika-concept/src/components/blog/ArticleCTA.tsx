  ...
  return (
    <section className="rounded-[1.8rem] border border-[var(--line)] bg-[var(--forest)] px-6 py-10 text-[var(--on-primary)] md:px-9">
      ...
      <div className="mt-6 flex flex-wrap gap-3">
        <Link href="/quiz" className="rounded-full bg-white px-5 py-2.5 text-xs uppercase tracking-[0.13em] text-[var(--forest)]">
          Start quiz
        </Link>
        <Link href="/products" className="rounded-full border border-white/45 px-5 py-2.5 text-xs uppercase tracking-[0.13em] text-white">
          Browse formulas
        </Link>
      </div>
    </section>
